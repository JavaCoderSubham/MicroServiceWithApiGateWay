...
public class FeignSecurity {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		return http.csrf().disable()
					...
					.requestMatchers("/feign1/create/single").permitAll()
					.and()
					
					.authorizeHttpRequests()
					.requestMatchers("/feign1/create/**")
					.authenticated()
					.and()
					
					.authorizeHttpRequests()
					.requestMatchers("/feign1/create/**").hasAnyRole("USER","ADMIN")
					.and()
					
					.authorizeHttpRequests()
					.requestMatchers("/feign1/create/update/**").hasAnyRole("ADMIN")
